...
The rule wins. ELARA should respect hard rules — if it's violating one, that's a bug. Report it at [github.com/ajitgunturi/longeviti-framework/issues](https://github.com/ajitgunturi/longeviti-framework/issues).
...
You're reading this on [longeviti.app](https://longeviti.app). If the site is misbehaving (404s, broken styles), report it at [github.com/ajitgunturi/longeviti-site/issues](https://github.com/ajitgunturi/longeviti-site/issues). This site is independent from the app, so a site outage doesn't affect your data or the app itself.
