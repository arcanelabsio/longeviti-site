...
- **No server-side storage of your health data.** There are no Longeviti servers. The app + your Drive + your AI assistant is the entire system.
...
- Publishes APK releases on the [longeviti-site releases page](https://github.com/arcanelabsio/longeviti-site/releases).
- Maintains the public [longeviti-framework](https://github.com/arcanelabsio/longeviti-framework) repo with the schemas and skills your AI uses.
