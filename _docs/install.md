...
<p>
  <a class="btn btn--solid" href="https://github.com/ajitgunturi/longeviti-site/releases/latest/download/longeviti.apk">Download longeviti.apk ↓</a>
  &nbsp;
  <a href="https://github.com/ajitgunturi/longeviti-site/releases">All releases</a>
</p>
...
1. Download the new APK from [releases](https://github.com/ajitgunturi/longeviti-site/releases)
...
Subscribe to releases: on the [releases page](https://github.com/ajitgunturi/longeviti-site/releases), click **Watch** → **Custom** → **Releases** — you'll get an email each time.
...
F-Droid submission is under consideration. The blocker is reproducible builds and some transitive dependencies that use Google Play Services (Drive SDK) — F-Droid's guidelines around these are strict. If you'd like to help with this, see the framework's [CONTRIBUTING](https://github.com/ajitgunturi/longeviti-framework/blob/main/CONTRIBUTING.md).
...
- Wait for the TestFlight build (no firm ETA — follow [releases](https://github.com/ajitgunturi/longeviti-site/releases))
