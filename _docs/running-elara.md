...
ELARA does not directly write to `plans/` or `rules.yaml`. Plan changes always go through ATLAS. This separation is architectural — see [ADR-002 in the framework](https://github.com/ajitgunturi/longeviti-framework/blob/main/docs/adr/002-atlas-elara-pipeline-separation.md).
